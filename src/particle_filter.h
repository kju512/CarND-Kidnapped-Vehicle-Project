...
public:
	...
	const bool initialized() const {
        ...
        */
        double calculateGaussianDisValue(double x,double y,double x_mean,double y_mean,double std_x,double std_y);
        /**
        * transform observation coordinate to the map coordinate
        */
        void transformObsToMap(double* x,double* y,double x0,double y0,double theta);
};
